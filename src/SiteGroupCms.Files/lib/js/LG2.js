(function ($)
{
    ...
    {
        var p = options || {};
        var ashxUrl = options.ashxUrl || "../../ajaxhandler/loadbutton.aspx?";
    ...
    LG.getPageMenuNo = function ()
    {
        ...
        var menuno =document.getElementById("MenuNo").attributes["value"].value;// $("#MenuNo").val();
        if (!menuno)
        {
    ...
    LG.appendSearchButtons = function (form, grid)
    {
        ...
        var container = $('<ul><li></li></ul><div class="l-clear"></div>').appendTo(form);
    ...
    LG.loadToolbar = function (grid, toolbarBtnItemClick) //创建工具栏
    {
