...
disign by  王洋  2012.5
创业团队 云作坊
功能：jquery 弹出框处理函数  弹出的是一个单独的页面，可以是html php 文件，也可以是图片
*/
...
$("#TB_overlay").show();
		...
		if(urlType == '.jpg' || urlType == '.jpeg' || urlType == '.png' || urlType == '.gif'){//code to show images
			...
			$("#TB_window").append("<img id='TB_Image' src='"+url+"' width='"+imgPreloader.width+"' height='"+imgPreloader.height+"' alt='"+caption+"'/>"+ "<div id='TB_caption'>"+caption+"</div><div id='TB_closeWindow'><a href='#' id='TB_closeWindowButton'><img src='./close.jpg' border=0></a></div>"); 
...
*/			
			...
			//关闭按钮
			//TB_closeAjaxWindow 属性是弹出框上面的css
			$("#TB_window").append("<div id='TB_closeAjaxWindow'><span style='float:left;padding-left:8px;'></span><a href='#' id='TB_closeWindowButton'><img src='/lib/images/close.jpg' border=0></a></div><div id='TB_ajaxContent' style='width:"+ajaxContentW+"px;height:"+ajaxContentH+"px;'></div>");
			$("#TB_closeWindowButton").click(TB_remove);
