        ...
        private string _cutSubstringFromStringWithTrim(ref string s, char c, int startIndex)
       {
        ...
        public void DeleteFile(string RemoteFileName)
        {
            try
            {
                ...
                Response = Open(new Uri(this.Uri.ToString() + 
                        RemoteFileName), WebRequestMethods.Ftp.DeleteFile);
            }
            catch (Exception ep)
            {
                ErrorMsg = ep.ToString();
           ...
           try
            {
                ...
                {
                    Request = OpenRequest(new Uri(this.Uri.ToString() + 
                         RemoteFileName), WebRequestMethods.Ftp.Rename);
           ...
           try
            {
               ...
               Response = Open(new Uri(this.Uri.ToString() + 
                        DirectoryName), WebRequestMethods.Ftp.MakeDirectory);
               return true;
           }
            catch (Exception ep)
            {
        ...
        public bool RemoveDirectory(string DirectoryName)
        {
            try
            {
                ...
                Response = Open(new Uri(this.Uri.ToString() + 
                         DirectoryName), WebRequestMethods.Ftp.RemoveDirectory);
               return true;
            }
            catch (Exception ep)
            {
